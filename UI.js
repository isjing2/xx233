                    ...
                    <vertical>
                        <vertical gravity="center" layout_weight="1">
                            ...
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                                    <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                        <text text="悬浮窗权限" textColor="#222222" textSize="16sp" maxLines="1" />"ui";
...
ui.start.click(function () {
    ...
    threads.start(function () {
        let url = [
            'https://ghproxy.com/https://raw.githubusercontent.com/zdu2022/xx233/main/'+ui.script_chosen.getSelectedItemPosition()+'.js',
            'https://cdn.jsdelivr.net/gh/zdu2022/xx233@main/'+ui.script_chosen.getSelectedItemPosition()+'.js',
            'https://raw.githubusercontent.com/zdu2022/xx233/main/'+ui.script_chosen.getSelectedItemPosition()+'.js',
        ];
