...
function noverify() {
    var noverify_thread = threads.start(function () {
        ...
        while (true) {
            ...
            var x_mid = (x_end - x_start) * random(5, 8) / 10 + x_start;auto.waitFor();
importClass(android.database.sqlite.SQLiteDatabase);
importClass("java.security.SecureRandom");
importClass("java.security.MessageDigest");
importClass("javax.crypto.spec.DESKeySpec");
...
var url = 'https://gh.api.99988866.xyz/https://raw.githubusercontent.com/sec-an/Better-Auto-XXQG/main/Study/QuestionBank.db';
var path = '/sdcard/QuestionBank.db';
device.wakeUpIfNeeded(); //点亮屏幕
var first = true; //记录答题的第一次
var r; // 替换用；
...
var init_true = false;
var downloadDialog = null;
var init_url = 'https://gh.api.99988866.xyz/https://raw.githubusercontent.com/sec-an/Better-Auto-XXQG/main/Study/question';
var file_tmp = false;
var tikus = '';
/**
 * 获取用户token
...
function show_log() {
    threads.start(function () {
        try {
            var text = http.get('https://gh.api.99988866.xyz/https://raw.githubusercontent.com/sec-an/Better-Auto-XXQG/main/Study/showlogs').body.string();
            if (text.length == 0) {
                show_log = true;
                return;
            }
...
function init() {
    ...
    threads.start(function () {
        try {
            var x = http.get('https://gh.api.99988866.xyz/https://raw.githubusercontent.com/sec-an/Better-Auto-XXQG/main/Study/replace.js').body.string();
            files.write('/sdcard/replace.js', x);
            r = require('/sdcard/replace.js');
        } catch (e) {}
        x = null;
